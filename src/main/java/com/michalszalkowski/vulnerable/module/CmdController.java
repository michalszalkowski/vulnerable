...
public class CmdController {
	...
	private static String execute(String payloadName, String cmd) throws IOException {
		return executeV2(payloadName, cmd);
	}

	private static String executeV1(String payloadName, String cmd) throws IOException {
	...
	private static String executeV2(String payloadName, String cmd) throws IOException {
